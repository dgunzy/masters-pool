...
app.get("/data", (req, res) => {
  if (global.entryObjects) {
    ...
    res
      .status(503)
      .send("Golf data is not available yet. Please try again later.");
  }
});

fetchGolfData();

//  Need to change this back - disableing api requests for now
setInterval(fetchGolfData, 5 * 60 * 1000 * 100);
